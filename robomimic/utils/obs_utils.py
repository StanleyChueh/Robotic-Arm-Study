...
def normalize_obs(obs_dict, obs_normalization_stats):
    ...
    assert obs_normalization_stats is not None, "Error: obs_normalization_stats is None!"
    assert set(obs_dict.keys()).issubset(set(obs_normalization_stats.keys())), "Mismatched keys detected!"
